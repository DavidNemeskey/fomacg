...
aggressively is required. % TODO word order
...
Automata Mista, due to Huet \shortcite{Huet:2004, Huet:2005}, and the method of
XXX.
% TODO: Huet, HFST: only works for lexicons
% TODO: Yli-Jyra: didn't try
% TODO: FSA memory report -- I think foma's memory layout already complies
