...
We record both initialization and rule application time for the two programs,
via instrumentation in case of \texttt{fomacg\_proc} and by running the grammar
...
concerned with the time required for applying rules.
