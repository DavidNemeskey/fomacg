...
Tapanainen~\shortcite{Tapanainen:1996} and lately, the open source VISL
...
FSTs; finally, Yli-Jyra~\shortcite{Yli-Jyra:2011} creates a single FST from the
...
Hulden~\shortcite{Hulden:2009a,Hulden:2009b}. We show that while \emph{foma} is fast,
...
analyzed input in the Apertium stream format, converts it into the format
...
Hulden~\shortcite{Hulden:2011} showed that if the rules are compiled to bimachines,
...
https://google-melange.appspot.com/gsoc/project/google/gsoc2013/davidnemeskey/14002}. The authors would like to thank Mans Hulden for
his insights.
