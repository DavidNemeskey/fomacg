...
\only<1>{\texttt{\$0\$ "\textbf{well}" \#BOC\# | \#0\# "well" <n> <sg> <nom> | \#0\# "well" <adj> <sg> <nom> | \#EOC\#}\\}
\only<2>{\texttt{\color{red}\$0\$ "\textbf{well}" \#BOC\# | \#0\# "well" <n> <sg> <nom> | \#0\# "well" <adj> <sg> <nom> | \#EOC\#}\\}
\only<3>{\texttt{\$0\$ "\textbf{well}" \#BOC\# | {\color{red}\#0\# "well" <n> <sg> <nom>} | {\color{red}\#0\# "well" <adj> <sg> <nom>} | \#EOC\#}\\}
...
\texttt{\$0\$ "\textbf{is}" \#BOC\# | \#0\# "be" <vbser> <pres> <s3p> | \#EOC\#}\\
\only<1>{\texttt{\$0\$ "\textbf{well}" \#BOC\# | \#0\# "well" <n> <sg> <nom> | \#0\# "well" <adj> <sg> <nom> | \#EOC\#}\\}
\only<2>{\texttt{\$0\$ "\textbf{well}" \#BOC\# | \textbf{\color{red}\#X\#} "well" <n> <sg> <nom> | \#0\# "well" <adj> <sg> <nom> | \#EOC\#}\\}
\texttt{\$0\$ "\textbf{.}" \#BOC\# | \#0\# "." <punct> | \#EOC\#}
