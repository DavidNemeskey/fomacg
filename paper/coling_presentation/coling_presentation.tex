...
\texttt{\$0\$ "All" \#BOC\# | \#0\# "all" <n> <sg> <nom> | \#EOC\#}\\
\texttt{\$0\$ "is" \#BOC\# | \#0\# "be" <vbser> <pres> <s3p> | \#EOC\#}\\
\only<1>{\texttt{\$0\$ "well" \#BOC\# | \#0\# "well" <n> <sg> <nom> | \#0\# "well" <adj> <sg> <nom> | \#EOC\#}\\}
\only<2>{\texttt{\color{red}\$0\$ "well" \#BOC\# | \#0\# "well" <n> <sg> <nom> | \#0\# "well" <adj> <sg> <nom> | \#EOC\#}\\}
\only<3>{\texttt{\$0\$ "well" \#BOC\# | {\color{red}\#0\# "well" <n> <sg> <nom>} | {\color{red}\#0\# "well" <adj> <sg> <nom>} | \#EOC\#}\\}
\texttt{\$0\$ "." \#BOC\# | \#0\# "." <punct> | \#EOC\#}
...
\texttt{\$0\$ "is" \#BOC\# | \#0\# "be" <vbser> <pres> <s3p> | \#EOC\#}\\
\only<1>{\texttt{\$0\$ "well" \#BOC\# | \#0\# "well" <n> <sg> <nom> | \#0\# "well" <adj> <sg> <nom> | \#EOC\#}\\}
\only<2>{\texttt{\$0\$ "well" \#BOC\# | \textbf{\color{red}\#X\#} "well" <n> <sg> <nom> | \#0\# "well" <adj> <sg> <nom> | \#EOC\#}\\}
\texttt{\$0\$ "." \#BOC\# | \#0\# "." <punct> | \#EOC\#}
...
\begin{frame}[fragile]
  ...
  \only<2>{\frametitle{Naïve baseline}}
% TODO algorithm
\begin{semiverbatim}
